...
//Double.toString(logic.AnalyzePiece(board, Helper.getIndex(x, y, board)))
                    g2.setFont(font);
                    g2.setColor(Color.red);
                    g2.drawString(Double.toString(logic.AnalyzePiece(board, Helper.getIndex(x, y, board))),(x * size)+10, (y * size)+10);
                }
                if (color == 0) {
                    color = 1;
                } else {
